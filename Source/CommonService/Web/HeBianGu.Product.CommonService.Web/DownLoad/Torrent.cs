...
namespace HeBianGu.Product.CommonService.Web
{
    public class Torrent
    {
        ...
        /// <summary>  是否正常打开文件  </summary>
        [Description("是否正常打开文件")]
        public bool OpenFile { set { _openFile = value; } get { return _openFile; } }

        /// <summary>  服务器的URL(字符串)  </summary>
        [Description("服务器的URL(字符串)")]
        public string Announce { set { _announce = value; } get { return _announce; } }

        /// <summary>  备用tracker服务器列表(列表)  </summary>
        [Description("备用tracker服务器列表(列表)")]
        public IList<string> AnnounceList { set { _announceList = value; } get { return _announceList; } }

        /// <summary> 种子创建的时间，Unix标准时间格式，从1970 1月1日 00:00:00到创建时间的秒数(整数)  </summary>
        [Description("种子创建的时间，Unix标准时间格式，从1970 1月1日 00:00:00到创建时间的秒数(整数)")]
        public DateTime CreateTime { set { _createTime = value; } get { return _createTime; } }

        /// <summary>  未知数字CodePage </summary>
        [Description("未知数字CodePage")]
        public long CodePage { set { _codePage = value; } get { return _codePage; } }

        /// <summary>  种子描述  </summary>
        [Description("种子描述")]
        ...
        /// <summary> 种子名UTF8 </summary>
        [Description("种子名UTF8")]
        public string NameUTF8 { set { _nameUTF8 = value; } get { return _nameUTF8; } }

        /// <summary> 每个块的大小，单位字节(整数) </summary>
        [Description("每个块的大小，单位字节(整数)")]
        public long PieceLength { set { _pieceLength = value; } get { return _pieceLength; } }

        /// <summary> 每个块的20个字节的SHA1 Hash的值(二进制格式) </summary>
        [Description("每个块的20个字节的SHA1 Hash的值(二进制格式)")]
        ...
        /// <summary> 包含文件的总长度 </summary>
        [Description("包含文件的总长度")]
        ...
        /// <summary> 获取列表方式 "I1:Xe"="X" 会调用GetKeyText </summary>
        ...
        /// <summary> 对应结构 INFO 多个文件时 </summary>
